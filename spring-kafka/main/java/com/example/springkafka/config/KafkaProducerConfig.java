...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Manager> managerProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, Manager> managerKafkaTemplate() {
        return new KafkaTemplate<>(managerProducerFactory());
    }
